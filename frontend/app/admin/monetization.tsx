...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  eligibilityPill: { flex: 1, backgroundColor: colors.background.tertiary, borderRadius: 12, padding: 12, alignItems: 'center', borderWidth: 1, borderColor: colors.border },
  eligibilityPillMet: { backgroundColor: colors.background.secondary, borderColor: colors.success },
  eligibilityLabel: { color: colors.text.secondary, fontSize: 12, fontWeight: '600', textAlign: 'center' },
  eligibilityLabelMet: { color: colors.success },
  eligibilityValue: { color: colors.text.primary, fontSize: 16, fontWeight: '700', marginTop: 4 },
  eligibilityValueMet: { color: colors.success },
  approvalRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  approvalText: { color: colors.text.primary, fontWeight: '600', flex: 1 },
  viewDetailsBtn: { backgroundColor: colors.background.secondary, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12, borderWidth: 1, borderColor: colors.border },
  ...
  addMethodBtn: { borderWidth: 1, borderColor: colors.border, paddingVertical: 8, borderRadius: 12, marginBottom: 16, backgroundColor: colors.background.secondary },
